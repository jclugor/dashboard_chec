        ...
        daily_frame=pd.DataFrame(
            {
                ...
                "SAIDI": [0.2, 0.2, 0.2, 6.0, 0.2, 0.2, 0.2, 1.0, 0.2, 0.2],
                "SAIFI": [0.1, 0.1, 0.1, 2.5, 0.1, 0.1, 0.1, 0.2, 0.1, 0.1],
...
def test_orchestrator_accepts_valid_structured_llm(tmp_path: Path, monkeypatch) -> None:
    ...
    chunk = {
        "chunk_id": "chunk-1",
        "document_id": "doc-1",
        "document_title": "Guia de confiabilidad",
        "source_path": "guia.pdf",
        "text": "SAIDI y SAIFI son indicadores de confiabilidad del servicio.",
    }
    raw_narrative = {
        "source": "llm",
        ...
        "point_narratives": [
            {
                ...
                "why_marked": ["SAIDI alto segun el detector."],
                "observed_values": ["SAIDI=6.0"],
                "likely_drivers": ["Revision operativa soportada por la evidencia estructurada."],
                "documentary_support": ["Documento citado [1]."],
        ...
        "evidence_matrix": [
            {
                ...
                "documentary_evidence": "Guia de confiabilidad [1].",
                "confidence": "medium",
                "citations_used": [1],
            }
        ],
    ...
    monkeypatch.setattr(
        "chec_dashboard.services.timeseries_interpretability.orchestrator.retrieve_chatbot_chunks",
    ...
    assert run.trace.mode == "llm_structured"
