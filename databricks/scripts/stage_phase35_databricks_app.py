...
def _render_app_yaml(template_text: str) -> str:
    ...
    replacements = {
        ...
        "__LLM_CHEAP_ENDPOINT_NAME__": os.getenv("APP_LLM_CHEAP_ENDPOINT_NAME", ""),
        "__LLM_MEDIUM_ENDPOINT_NAME__": os.getenv("APP_LLM_MEDIUM_ENDPOINT_NAME", ""),
        "__LLM_BEST_ENDPOINT_NAME__": os.getenv("APP_LLM_BEST_ENDPOINT_NAME", ""),
        "__LLM_ALLOW_BEST_TIER__": os.getenv("APP_LLM_ALLOW_BEST_TIER", "false"),
        "__LLM_MAX_EXPENSIVE_CALLS_PER_REQUEST__": os.getenv("APP_LLM_MAX_EXPENSIVE_CALLS_PER_REQUEST", "1"),
        "__LLM_ROUTE_SIMPLE_TO_CHEAP__": os.getenv("APP_LLM_ROUTE_SIMPLE_TO_CHEAP", "true"),
        "__LLM_MAX_TOKENS__": os.getenv("APP_LLM_MAX_TOKENS", "1200"),
        "__LLM_TEMPERATURE__": os.getenv("APP_LLM_TEMPERATURE", "0.2"),
        "__CHATBOT_ENABLED__": os.getenv("APP_CHATBOT_ENABLED", "true"),
        ...
        "__RETRIEVER_BACKEND__": os.getenv("APP_RETRIEVER_BACKEND", "databricks_ai_search"),
