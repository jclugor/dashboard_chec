...
APP_CONTEXT_TOOL_FUNCTIONS="${APP_CONTEXT_TOOL_FUNCTIONS:-get_dashboard_context,get_reliability_summary,get_compliance_context,get_event_context,get_asset_context,get_circuit_history,get_timeseries_interpretability_context}"
